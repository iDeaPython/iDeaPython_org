...
class MPU6050_JY61P():
    ...
    def angleSpin(self,angle, Maxlevel=20): # convert 1-360 to 1-20
...
>>>[num1,num2,num3]
# HOWTO GPIO angle to direction or move, format of level is L/Rx, eg.L4 or R6
