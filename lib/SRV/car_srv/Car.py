...
class Car():
    def __init__(self, driver, steering, watchCar=None):
        ...
        self.lastM1 = ''
        self.lastData = ''
        self.sensitivity = ('watchCar',1000)
        self.D, self.M = '', ''
    ...
    def go(self, data, soloRemote=1):
        if soloRemote == 0:
            ...
            if data == 'offline':
                ...
                try:
                    if self.RunAfter( self.delay[0],self.delay[1] ):  # in order to slow down gryo action.
            ...
            if self.watchCar != 0:
                ...
                if self.RunAfter( self.sensitivity[0], self.sensitivity[1]):
